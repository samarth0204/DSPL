...
import "../stylesheets/aboutUs.css";  // Importing the updated CSS

const AboutUs = () => {
  const [scrollY, setScrollY] = useState(0);

  // Hook to update scroll position
  useEffect(() => {
    const handleScroll = () => {
    ...
    <section className="about-us">
      <div className="about-images">
        <img
          src={img1}
          alt="image1"
          style={{ transform: `translateY(${scrollY * 0.15}px)` }}  // Slight down
        />
        <img
          src={img2}
          alt="image2"
          style={{ transform: `translateY(${scrollY * -0.15}px)` }} // Slight up
        />
        <img
          src={img3}
          alt="image3"
